...
type User struct {
	...
	CodexQuotaShareBps int            `json:"codex_quota_share_bps" gorm:"type:int;default:0;column:codex_quota_share_bps"`
	CodexQuotaBonusBps int            `json:"codex_quota_bonus_bps" gorm:"type:int;default:0;column:codex_quota_bonus_bps"`
}
